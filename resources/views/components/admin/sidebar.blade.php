<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a class="nav-link {{ request()->is('admin/manage-schedule') ? 'active' : '' }}" href="{{ url('/admin/manage-schedule') }}">
            <i class="fas fa-calendar"></i> Kelola Jadwal
        </a>
        <a class="nav-link {{ request()->is('admin/manage-rooms') ? 'active' : '' }}" href="{{ url('/admin/manage-rooms') }}">
            <i class="fas fa-door-open"></i> Kelola Ruangan
        </a>
        <a class="nav-link {{ request()->is('admin/manage-semester') ? 'active' : '' }}" href="{{ url('/admin/manage-semester') }}">
            <i class="fas fa-calendar-alt"></i> Kelola Semester
        </a>

        <span class="nav-section-label">Pengaturan</span>
        <a class="nav-link {{ request()->is('admin/manage-settings') ? 'active' : '' }}" href="{{ url('/admin/manage-settings') }}">
            <i class="fas fa-cog"></i> Pengaturan
        </a>
        <a class="nav-link {{ request()->is('admin/manage-users') ? 'active' : '' }}" href="{{ url('/admin/manage-users') }}">
